...
<!--
 function getgoing()
  {
    top.location="shop_log.php?" + location.search.substring(1);
   }
...
<table   border="0" align="center" cellpadding="1" cellspacing="0" class="yb_standardCENTER">
  <tr>
    <td height="900" valign="top"><p class="yb_standardCENTERred">First-time sign in almost complete </p>
      ...
      <p>&nbsp;</p>
    <p><a href="shop_log.php">Click here to return to the shop login page</a></p>
    </td>
  </tr>
</table>
<p>&nbsp;</p>
<!--
SRC="http://groups.google.com/group/yellowbike-newsletter/boxsubscribe?email=<?php echo $email;?>" WIDTH=760 HEIGHT=500>
-->
</IFRAME>
